...
class LineEndingRetryTests(unittest.TestCase):
    def _apply_patch(self, original: bytes, expected: bytes) -> None:
...
"""
            ...
            logs = LogSink([])
            asyncio.run(_apply_patch_with_line_ending_retry(repo_dir, patch_path, patch_content, {}, logs))
...
"""
    ...
    def test_git_apply_retry_preserves_mixed_line_endings(self) -> None:
        self._apply_patch(
            b"one\r\ntwo\nthree\r\n",
            b"one\r\nTWO\nthree\r\n",
        )
